...
def create_profile_periodic_tasks(requests, account_id, **kwargs):
    op = create_profile_periodic_tasks.__name__
    _logger.log_event(op, "receiver is running...")
    _profile_svc.config.create_update_profile_info_periodic_task(account_id)
